...
RfuBot=[lineMID]
Family=["ub8fd0c502d6d52c35d8bc6fcced407d0",lineMID]
admin=['ub8fd0c502d6d52c35d8bc6fcced407d0',lineMID]
    ...
    try:
        ...
        if op.type == 5:
            if settings["autoAdd"] == True:
                line.sendContact(to, "ub8fd0c502d6d52c35d8bc6fcced407d0")
...
#===========
                    ...
                    line.sendMessage(to,"บอทตายแล้ว T_T")       
#==============================================================================#
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                               ...
                               mi_d = Mids[:33]
                               line.createGroup("【さัএπัஞ✵ບิथℓℓҨतΩ】",mi_d)
                               line.sendText(msg.to,"【さัএπัஞ✵ບิथℓℓҨतΩ】")
                               line.createGroup("【さัএπัஞ✵ບิथℓℓҨतΩ】",mi_d)
                               line.sendText(msg.to,"【さัএπัஞ✵ບิथℓℓҨतΩ】")
                               line.createGroup("【さัএπัஞ✵ບิथℓℓҨतΩ】",mi_d)
                               line.sendText(msg.to,"【さัএπัஞ✵ບิथℓℓҨतΩ】")
...
#===================================================================#              
                    ...
                    if receiver in read['readPoint']:
                        ...
                        line.sendMessage(receiver,"ดูคนอ่านเรียบร้อย\nBY:【さัএπัஞ✵ບิथℓℓҨतΩ】")                
#==============================================================================#
#=============================================#                    
...
#==============================================================================#
                    ...
                    settings["Api"] = True
                    line.sendMessage(msg.to,"เปิดระบบบอท API")
                
                elif msg.text in ["ปิดพูด"]:
                    settings["Api"] = False
                    line.sendMessage(msg.to,"ปิดระบบบอท API")
...
#=============COMMAND KICKER===========================#
                ...
                elif "แม็คจ๋า" in msg.text:
                	if msg.toType == 2:
                         _name = msg.text.replace("แม็คจ๋า","")
                         ...
                         if matched_list == []:
                             ...
                             for jj in matched_list:
                                 try:
                                     ...
                                     line.sendMessage(receiver,"BY:【さัএπัஞ✵ບิथℓℓҨतΩ】 ")
...
#==============================================================================#
        ...
        if op.type == 26:
            ...
            if settings ["Api"] == True:
            	if msg.text in ["ป๊า","แม็ค","เพื่อน","จาร์ย","อาจาร์ย","เฮีย"]:
                    line.sendMessage(msg.to, str(settings["comment"]))
            if settings ["Api"] == True:
                    ...
                    if "/ti/g/" in msg.text.lower():
                        if settings["autoJoinTicket"] == True:
                            ...
                            for ticket_id in n_links:
                                ...
                                line.sendMessage(to, "🔰เข้าไปในกลุ่ม %s เรียบร้อยแล้ว🔰" % str(group.name))
        ...
        if op.type == 15:
           ...
           if settings["Lv"] == True:
             ...
             dan = line.getContact(op.param2)
             tgb = line.getGroup(op.param1)
             line.sendMessage(op.param1,str(settings["bye"]) + "\n {}, ไปซะละ {} \nลาก่อนฮือ 😭❋".format(str(dan.displayName),str(tgb.name)))
             line.sendContact(op.param1, op.param2)
             line.sendImageWithURL(op.param1, "http://dl.profile.line-cdn.net{}".format(dan.picturePath))
        if op.type == 55:
            try:
